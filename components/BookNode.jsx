...
export default function BookNode({ book, onDragStart, onStartConnection, isFocused, onToggleFocus }) {
  ...
  return (
    <div
      ...
      data-node-type="book"
      className="absolute aero-panel w-48 cursor-grab active:cursor-grabbing group"
      style={{
        left: book.x_pos,
        top: book.y_pos,
        touchAction: "none",
